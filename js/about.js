...
div1.addEventListener('click',()=>{
    img1.setAttribute('src','images/aim-1-colored.png')
    img2.setAttribute('src','images/aim-2.png');
    img3.setAttribute('src','images/aim-3.png')
...
div2.addEventListener('click',()=>{
    img1.setAttribute('src','images/aim-1.png')
    img2.setAttribute('src','images/aim-2-colored.png');
    img3.setAttribute('src','images/aim-3.png')
...
div3.addEventListener('click',()=>{
    img1.setAttribute('src','images/aim-1.png')
    img2.setAttribute('src','images/aim-2.png');
    img3.setAttribute('src','images/aim-3-colored.png')
